...
# Clean eRNA column names and assign groups
...
run_pca_plot <- function(expr_mat, group_vec, title_text) {
  # Data transformation and variance calculation
